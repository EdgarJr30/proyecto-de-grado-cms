  ...
  return (
    <div className="px-4 md:px-6 lg:px-8 py-4">
      <InventoryFiltersDropdown
        ...
        description={
          <>
            Filtra por repuesto, almacén, fechas, documento, ticket y tipo.
            {selectedCount > 0 ? (
              <span className="ml-1">
        ...
        searchValue={q}
        searchPlaceholder="doc_no, referencia, repuesto, almacén, ubicación..."
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
          ...
          <div className="md:col-span-3">
            ...
            <select
              value={warehouseId}
              onChange={(e) => onChangeWarehouseId((e.target.value as UUID) || '')}
              disabled={optionsLoading}
              className={cx(
                'mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-200',
                optionsLoading && 'cursor-not-allowed opacity-70'
          ...
          <div className="md:col-span-2">
            ...
            <select
              value={docType}
              onChange={(e) => onChangeDocType((e.target.value as DocType) || '')}
              className="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-200"
            >
          ...
          <div className="md:col-span-2">
            ...
            <select
              value={movementSide}
              onChange={(e) => onChangeMovementSide((e.target.value as Side) || '')}
              className="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-200"
            >
              <option value="">Todos</option>
              {sides.map((s) => (
            ...
            <div className="mt-1 flex items-center gap-2">
              <button
                ...
                className={cx(
                  ...
                  (isLoading || page <= 1) && 'cursor-not-allowed opacity-40'
                )}
              ...
              <div className="min-w-0 flex-1">
                <div className="flex h-10 items-center rounded-xl border border-slate-200 bg-white shadow-sm focus-within:ring-2 focus-within:ring-indigo-200">
                  <input
                    ...
                    inputMode="numeric"
                    className={cx(
                      'w-14 bg-transparent px-3 text-center text-sm font-semibold text-slate-900 outline-none'
                    )}
